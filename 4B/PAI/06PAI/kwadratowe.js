...
/**
 * Główna funkcja obliczająca miejsca zerowe równania kwadratowego i opcjonalnie rysująca wykres.
 * @param {number} a - Współczynnik przy x^2.
 * @param {number} b - Współczynnik przy x.
 * @param {number} c - Wyraz wolny.
 * @param {boolean} [drawGraph=false] - Flaga, czy rysować wykres.
 * @returns {Array<number>|boolean} Zwraca tablicę miejsc zerowych jeśli istnieją, lub `false` w przypadku błędnych danych.
 */
